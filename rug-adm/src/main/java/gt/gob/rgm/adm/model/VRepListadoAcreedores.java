 ...
 */
@Entity
@Table(name="V_REP_LISTADO_ACREEDORES")
@NamedQuery(name="VRepListadoAcreedores.findAll", query="SELECT va FROM VRepListadoAcreedores va")
public class VRepListadoAcreedores implements Serializable {
