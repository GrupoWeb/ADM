...
public class ConstantsCv {
    ...
    // SETTING SIGNATURE API

    public static final String SIGN_OUT                 = "SIGN_OUT";
    public static final String SIGN_BACK                = "SIGN_BACK";
    public static final String SIGN_ENV                 = "SIGN_ENV";
    public static final String SIGN_FORMAT              = "SIGN_FORMAT";
    public static final String SIGN_USERNAME            = "SIGN_USERNAME";
    public static final String SIGN_PASS                = "SIGN_PASS";
    public static final String SIGN_PIN                 = "SIGN_PIN";
    public static final String SIGN_LEVEL               = "SIGN_LEVEL";
    public static final String SIGN_BILLING_USERNAME    = "SIGN_BILLING_USERNAME";
    public static final String SIGN_BILLING_PASSWORD    = "SIGN_BILLING_PASSWORD";
    public static final String SIGN_IMG_SIZE            = "SIGN_IMG_SIZE";
    public static final String SIGN_POSITION            = "SIGN_POSITION";
    public static final String SIGN_NPAGE               = "SIGN_NPAGE";
