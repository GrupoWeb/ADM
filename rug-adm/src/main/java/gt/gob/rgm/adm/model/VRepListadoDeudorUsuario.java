 ...
 */
@Entity
@Table(name="V_REP_DEUDORES_X_USUARIO")
@NamedQuery(name="VRepListadoDeudorUsuario.findAll", query="SELECT b FROM VRepListadoDeudorUsuario b")
public class VRepListadoDeudorUsuario implements Serializable {
	...
	public VRepListadoDeudorUsuario() {
	}
