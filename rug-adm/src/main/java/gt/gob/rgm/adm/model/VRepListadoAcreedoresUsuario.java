 ...
 */
@Entity
@Table(name="V_REP_ACREEDORES_X_USUARIO")
@NamedQuery(name="VRepListadoAcreedoresUsuario.findAll", query="SELECT va FROM VRepListadoAcreedoresUsuario va")
public class VRepListadoAcreedoresUsuario implements Serializable {
	...
	public VRepListadoAcreedoresUsuario() {
	}
